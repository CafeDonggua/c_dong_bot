...
def test_complete_by_id_marks_completed_and_excludes_default_list(tmp_path):
    ...
    command = parser.parse(f"把ID={schedule.schedule_id[:8]}的行程標記為已完成")
